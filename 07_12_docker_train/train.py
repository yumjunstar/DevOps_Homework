...
class ImageClassification():
    def __init__(self, train_path = "data/100_1", test_path = "data/100_2"):
    ...
    def train(self):
        ...
        self.history = self.model.fit(self.X_train, self.y_train, batch_size = 256, epochs = 100, validation_data=(self.X_val, self.y_val), callbacks=[es])
    def evaluate(self):
